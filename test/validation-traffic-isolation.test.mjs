...
test("Q: prompt golden is unchanged and fallback remains unable to authorize a natural-language write", async () => {
  ...
  assert.equal(Buffer.byteLength(admitted), 12012);
  assert.equal(createHash("sha256").update(admitted).digest("hex"), "de0c5eb0bef449915d92fd3f3deeb2ee7dd0643e70b082fc2f30b78a439efa06");
