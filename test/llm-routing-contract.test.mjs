...
const context = {
  requestId: "r",
  tenant: { id: "hotel-demo", slug: "hotel-demo", status: "active", allowedToolIds: ["hms.checkAvailability", "hms.getQuote"] },
...
test("router prompt makes availability critical fields capability-specific and forbids premature selection", async () => {
  const provider = {
    request: null,
