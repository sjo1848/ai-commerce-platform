...
Read `AGENTS.md`, `.orchestration/RUNTIME-POLICY.md`, the active contract/block plan/invariants and exact PR/review/CI evidence. Pin the candidate SHA before reviewing.
